...
sealed class  BookListViewModelState(open val errorMessage : String = "", open val successMessage : String = ""){
    ...
    data class Success(val books : List<Book>, override val successMessage: String) : BookListViewModelState(successMessage = successMessage)
    data class Failure(override val errorMessage: String) : BookListViewModelState(errorMessage = errorMessage)
}
...
class BookListViewModel : ViewModel() {
    ...
    fun getBookList(db : AppDatabase, owner : LifecycleOwner){
